          ...
          <main className=' min-h-[calc(100vh-410px)]'>
            <form onSubmit={ e => registrationFromHandler(e)} className=' w-[500px] mx-auto mt-[80px] mb-[60px]'>
              ...
              <div className="text-xs flex items-center pb-3">
                <span className='pr-3'>3 of 10 steps</span> |
              ...
              <section className='grid'>
                ...
                <div className="">
                  <label className=" text-xs font-light" htmlFor="">Which car do you have?</label>
                  <input type='number' placeholder="Enter your cars VIN" className=" focus:border-pickall-primary px-3 py-2 text-xs font-normal border outline-none block w-full border-gray-500 rounded-sm" required />
                </div>
