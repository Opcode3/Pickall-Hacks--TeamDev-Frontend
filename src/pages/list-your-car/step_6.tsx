...
export default function Home() {
  ...
  const submitHandler = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    router.push("/list-your-car/step_7");
  };
          ...
          <main className=" min-h-[calc(100vh-410px)]">
            ...
            >
              ...
              <div className="text-xs flex items-center pb-3">
                <span className="pr-3">6 of 8 steps</span> |
              ...
              <section className="grid gap-2">
                ...
                <div className="">
                  ...
                  <textarea
                    name=""
                    className=" focus:border-pickall-primary px-3 py-2 text-xs font-normal border outline-none block w-full border-gray-500 rounded-sm"
                    placeholder="No need to include your phone number or pickup instruction. Guest will recieve does once they book your car."
                    id=""
                    rows={7}
                  ></textarea>
                </div>
