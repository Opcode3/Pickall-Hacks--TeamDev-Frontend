          ...
          <main className=' min-h-[calc(100vh-410px)]'>
            <form onSubmit={ e => registrationFromHandler(e)} className=' w-[500px] mx-auto mt-[80px] mb-[60px]'>
              ...
              <div className="text-xs flex items-center pb-3">
                <span className='pr-3'>2 of 10 steps</span> |
                <span className='px-3'>Next: Drivers license</span> |
              ...
              <section className='grid'>
                <h3 className=' font-semibold mb-0'>Your Mobile Number</h3>
                <div className="">
                  <label className=" text-xs font-light" htmlFor="">Enter your active Nigeria business number</label>
                  <input type='number' placeholder="+2349159847323" className=" focus:border-pickall-primary px-3 py-2 text-xs font-normal border outline-none block w-full border-gray-500 rounded-sm" required />
                </div>
