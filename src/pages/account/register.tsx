      ...
      <UserLayout title=''>
        <>
          ...
          <main className=' min-h-[calc(100vh-410px)]'>
            <form onSubmit={ e => registrationFromHandler(e)} className=' w-[400px] mx-auto mt-[80px] mb-[60px]'>
              <h1 className=' text-3xl font-bold pb-3 w-fit'>
                Register
                <small className='text-xs block font-medium'>Create a new user account</small>
              </h1>
              <section className='grid gap-2'>
                <InputLabel placeholder='First Name' htmlRef={firstNameRef} type='text' />
                ...
                <InputLabel placeholder='Email address' htmlRef={emailRef} type='email' />
