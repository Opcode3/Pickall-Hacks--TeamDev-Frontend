...
export default function Home() {
  ...
  const maxTripDuration = [
    "5 days", "1 week", "2 weeks", "1 month", "3 months", "Any (recommended)"
  ]
          ...
          <main className=' min-h-[calc(100vh-410px)]'>
            <form onSubmit={ e => registrationFromHandler(e)} className=' w-[500px] mx-auto mt-[80px] mb-[60px]'>
              ...
              <div className="text-xs flex items-center pb-3">
                <span className='pr-3'>5 of 10 steps</span> |
              ...
              <section className='grid'>
                ...
                <div className="">
                  <label className=" text-xs font-light" htmlFor="">How much advance notice do you need before a trip start?</label>
                ...
                <div className="">
                  <label className=" text-xs font-light" htmlFor="">What is the shortest possible trip you'll accept?</label>
                  <select name="" className=" focus:border-pickall-primary px-3 py-2 text-xs font-normal border outline-none block w-full border-gray-500 rounded-sm">
                    {
                      tripDuration.map( goal => <option value={goal}>{goal}</option>)
                    }
                  </select>
                </div>
                <div className="">
                  <label className=" text-xs font-light" htmlFor="">What is the longest possible trip you'll accept?</label>
                  <select name="" className=" focus:border-pickall-primary px-3 py-2 text-xs font-normal border outline-none block w-full border-gray-500 rounded-sm">
                    {
                      maxTripDuration.map( goal => <option value={goal}>{goal}</option>)
                    }
                  </select>
                </div>
